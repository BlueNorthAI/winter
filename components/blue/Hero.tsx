...
export function Hero() {
  return (
    <div className="h-screen overflow-hidden bg-slate-900 dark:-mb-32 dark:mt-[-4.75rem] dark:pb-32 dark:pt-[4.75rem]">
      <div className="py-16 sm:px-2 lg:relative lg:px-0 lg:py-28">
        <div className="mt-16 mx-auto grid max-w-4xl items-center gap-x-8 gap-y-16 px-4 lg:max-w-8xl lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 text-center">
            ...
            <div className="relative mt-4">
              <p className="inline bg-gradient-to-r from-indigo-200 via-sky-400 to-indigo-200 bg-clip-text font-display text-8xl font-bold tracking-normal text-transparent">
                BlueNorth AI
              </p>
